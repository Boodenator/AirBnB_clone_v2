...
class test_inherit_basemodel(unittest.TestCase):
    """Test user inherition from BaseModel"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Test attr name with it's empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_values(self):
        """test that returned values in dict"""
    ...
    def test_str(self):
        """test right output of str method """
        amenity = Amenity()
